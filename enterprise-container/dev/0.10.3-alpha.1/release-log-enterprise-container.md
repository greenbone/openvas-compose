...
- Implement cancel_report_export GMP command by [@ozgen](https://github.com/ozgen) in [8ba4837](https://github.com/greenbone/gvmd/commit/8ba4837c4135153ac94bf5a5775a539f4565d366)
- Handle delayed report export cancellation by [@ozgen](https://github.com/ozgen) in [6049d6e](https://github.com/greenbone/gvmd/commit/6049d6e45467f98d9a3f519e36116d8d596a8466)

#### <!-- 2 -->:construction_worker: Changed

- Hold the report port buffers in the print context by [@mattmundell](https://github.com/mattmundell) in [0100165](https://github.com/greenbone/gvmd/commit/0100165fb23ecdac4156729dd303beb91529a98f)

#### <!-- 3 -->:bug: Bug Fixes

- Allow filtering by OID in NVT iterators by [@timopollmeier](https://github.com/timopollmeier) in [#3147](https://github.com/greenbone/gvmd/pull/3147) 
- Free the report iterator and stream when printing fails by [@mattmundell](https://github.com/mattmundell) in [#3148](https://github.com/greenbone/gvmd/pull/3148) 
- Free the report iterator leaked by manage_send_report_ports by [@mattmundell](https://github.com/mattmundell) in [#3149](https://github.com/greenbone/gvmd/pull/3149) 
- Do not fail sync if ZAP VTs file is missing by [@timopollmeier](https://github.com/timopollmeier) in [212b6bb](https://github.com/greenbone/gvmd/commit/212b6bb693211663d0f301b9d911f68f86ac0768)
- Load Web App VT files only if feature is on by [@timopollmeier](https://github.com/timopollmeier) in [#3152](https://github.com/greenbone/gvmd/pull/3152) 

#### <!-- 5 -->:books: Documentation

- Add cancel report export support by [@ozgen](https://github.com/ozgen) in [#3145](https://github.com/greenbone/gvmd/pull/3145) 

[26.40.0]: https://github.com/greenbone/gvmd/compare/v26.39.0..26.40.0
...
- TEMP-0841856-B18BAF (bash 5.2.37-2+b10, LOW)
...
- CVE-2025-10966 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2025-14017 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2025-15079 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2025-15224 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2026-10536 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-11856 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-12064 (curl 8.14.1-2+deb13u5, HIGH)
- CVE-2026-13608 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2026-18924 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2026-19931 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-80229 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-80230 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2026-80255 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2026-82208 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2026-82209 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2026-8286 (curl 8.14.1-2+deb13u5, HIGH)
- CVE-2026-8458 (curl 8.14.1-2+deb13u5, HIGH)
- CVE-2026-8924 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-8926 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-8927 (curl 8.14.1-2+deb13u5, HIGH)
- CVE-2026-8932 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-9079 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-9080 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-9545 (curl 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-9547 (curl 8.14.1-2+deb13u5, LOW)
- CVE-2026-53910 (diffutils 1:3.10-4, LOW)
- CVE-2022-3219 (dirmngr 2.4.7-21+deb13u1+b5, LOW)
- CVE-2025-68972 (dirmngr 2.4.7-21+deb13u1+b5, MEDIUM)
- CVE-2026-24882 (dirmngr 2.4.7-21+deb13u1+b5, HIGH)
- CVE-2026-57062 (dirmngr 2.4.7-21+deb13u1+b5, LOW)
...
- CVE-2022-3219 (gpg-agent 2.4.7-21+deb13u1+b5, LOW)
- CVE-2025-68972 (gpg-agent 2.4.7-21+deb13u1+b5, MEDIUM)
- CVE-2026-24882 (gpg-agent 2.4.7-21+deb13u1+b5, HIGH)
- CVE-2026-57062 (gpg-agent 2.4.7-21+deb13u1+b5, LOW)
- CVE-2022-3219 (gpgconf 2.4.7-21+deb13u1+b5, LOW)
- CVE-2025-68972 (gpgconf 2.4.7-21+deb13u1+b5, MEDIUM)
- CVE-2026-24882 (gpgconf 2.4.7-21+deb13u1+b5, HIGH)
- CVE-2026-57062 (gpgconf 2.4.7-21+deb13u1+b5, LOW)
- CVE-2022-3219 (gpgsm 2.4.7-21+deb13u1+b5, LOW)
- CVE-2025-68972 (gpgsm 2.4.7-21+deb13u1+b5, MEDIUM)
- CVE-2026-24882 (gpgsm 2.4.7-21+deb13u1+b5, HIGH)
- CVE-2026-57062 (gpgsm 2.4.7-21+deb13u1+b5, LOW)
- CVE-2022-3219 (gpg 2.4.7-21+deb13u1+b5, LOW)
- CVE-2025-68972 (gpg 2.4.7-21+deb13u1+b5, MEDIUM)
- CVE-2026-24882 (gpg 2.4.7-21+deb13u1+b5, HIGH)
- CVE-2026-57062 (gpg 2.4.7-21+deb13u1+b5, LOW)
...
- CVE-2010-4756 (libc-bin 2.41-12+deb13u4, LOW)
- CVE-2018-20796 (libc-bin 2.41-12+deb13u4, LOW)
- CVE-2019-1010022 (libc-bin 2.41-12+deb13u4, LOW)
- CVE-2019-1010023 (libc-bin 2.41-12+deb13u4, LOW)
- CVE-2019-1010024 (libc-bin 2.41-12+deb13u4, LOW)
- CVE-2019-1010025 (libc-bin 2.41-12+deb13u4, LOW)
- CVE-2019-9192 (libc-bin 2.41-12+deb13u4, LOW)
- CVE-2026-18374 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-19499 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-19542 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-5435 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-6238 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-6368 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-6791 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-77117 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-80489 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-8674 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-86805 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-89092 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2026-95818 (libc-bin 2.41-12+deb13u4, MEDIUM)
- CVE-2010-4756 (libc6 2.41-12+deb13u4, LOW)
- CVE-2018-20796 (libc6 2.41-12+deb13u4, LOW)
- CVE-2019-1010022 (libc6 2.41-12+deb13u4, LOW)
- CVE-2019-1010023 (libc6 2.41-12+deb13u4, LOW)
- CVE-2019-1010024 (libc6 2.41-12+deb13u4, LOW)
- CVE-2019-1010025 (libc6 2.41-12+deb13u4, LOW)
- CVE-2019-9192 (libc6 2.41-12+deb13u4, LOW)
- CVE-2026-18374 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-19499 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-19542 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-5435 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-6238 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-6368 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-6791 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-77117 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-80489 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-8674 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-86805 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-89092 (libc6 2.41-12+deb13u4, MEDIUM)
- CVE-2026-95818 (libc6 2.41-12+deb13u4, MEDIUM)
...
- CVE-2025-10966 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2025-14017 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2025-15079 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2025-15224 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2026-10536 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-11856 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-12064 (libcurl4t64 8.14.1-2+deb13u5, HIGH)
- CVE-2026-13608 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2026-18924 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2026-19931 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-80229 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-80230 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2026-80255 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2026-82208 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2026-82209 (libcurl4t64 8.14.1-2+deb13u5, LOW)
- CVE-2026-8286 (libcurl4t64 8.14.1-2+deb13u5, HIGH)
- CVE-2026-8458 (libcurl4t64 8.14.1-2+deb13u5, HIGH)
- CVE-2026-8924 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-8926 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-8927 (libcurl4t64 8.14.1-2+deb13u5, HIGH)
- CVE-2026-8932 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-9079 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-9080 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-9545 (libcurl4t64 8.14.1-2+deb13u5, MEDIUM)
- CVE-2026-9547 (libcurl4t64 8.14.1-2+deb13u5, LOW)
...
- CVE-2012-0039 (libglib2.0-0t64 2.84.4-3~deb13u5, LOW)
- CVE-2026-86469 (libglib2.0-0t64 2.84.4-3~deb13u5, MEDIUM)
...
- CVE-2026-15779 (libldb2 2:2.11.0+samba4.22.11+dfsg-0+deb13u1, MEDIUM)
...
- CVE-2011-4116 (libperl5.40 5.40.1-6+deb13u1, LOW)
- CVE-2026-15534 (libperl5.40 5.40.1-6+deb13u1, MEDIUM)
- CVE-2026-19487 (libperl5.40 5.40.1-6+deb13u1, MEDIUM)
- CVE-2026-82560 (libperl5.40 5.40.1-6+deb13u1, UNKNOWN)
- CVE-2026-9538 (libperl5.40 5.40.1-6+deb13u1, HIGH)
...
- CVE-2025-12781 (libpython3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-15366 (libpython3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-15367 (libpython3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-12003 (libpython3.13-minimal 3.13.5-2+deb13u5, LOW)
- CVE-2026-15308 (libpython3.13-minimal 3.13.5-2+deb13u5, HIGH)
- CVE-2026-15310 (libpython3.13-minimal 3.13.5-2+deb13u5, LOW)
- CVE-2026-15806 (libpython3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-17084 (libpython3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-18503 (libpython3.13-minimal 3.13.5-2+deb13u5, LOW)
- CVE-2026-19672 (libpython3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-3479 (libpython3.13-minimal 3.13.5-2+deb13u5, LOW)
- CVE-2026-7210 (libpython3.13-minimal 3.13.5-2+deb13u5, HIGH)
- CVE-2026-82049 (libpython3.13-minimal 3.13.5-2+deb13u5, HIGH)
- CVE-2026-87910 (libpython3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-12781 (libpython3.13-stdlib 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-15366 (libpython3.13-stdlib 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-15367 (libpython3.13-stdlib 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-12003 (libpython3.13-stdlib 3.13.5-2+deb13u5, LOW)
- CVE-2026-15308 (libpython3.13-stdlib 3.13.5-2+deb13u5, HIGH)
- CVE-2026-15310 (libpython3.13-stdlib 3.13.5-2+deb13u5, LOW)
- CVE-2026-15806 (libpython3.13-stdlib 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-17084 (libpython3.13-stdlib 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-18503 (libpython3.13-stdlib 3.13.5-2+deb13u5, LOW)
- CVE-2026-19672 (libpython3.13-stdlib 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-3479 (libpython3.13-stdlib 3.13.5-2+deb13u5, LOW)
- CVE-2026-7210 (libpython3.13-stdlib 3.13.5-2+deb13u5, HIGH)
- CVE-2026-82049 (libpython3.13-stdlib 3.13.5-2+deb13u5, HIGH)
- CVE-2026-87910 (libpython3.13-stdlib 3.13.5-2+deb13u5, MEDIUM)
...
- CVE-2026-15779 (libsmbclient0 2:4.22.11+dfsg-0+deb13u1, MEDIUM)
- CVE-2026-89147 (libsnmp-base 5.9.4+dfsg-2+deb13u1, UNKNOWN)
- CVE-2026-89147 (libsnmp40t64 5.9.4+dfsg-2+deb13u1, UNKNOWN)
- CVE-2021-45346 (libsqlite3-0 3.46.1-7+deb13u2, LOW)
- CVE-2025-70873 (libsqlite3-0 3.46.1-7+deb13u2, LOW)
- CVE-2026-50812 (libsqlite3-0 3.46.1-7+deb13u2, MEDIUM)
- CVE-2026-50813 (libsqlite3-0 3.46.1-7+deb13u2, MEDIUM)
...
- CVE-2026-15779 (libtalloc2 2:2.4.3+samba4.22.11+dfsg-0+deb13u1, MEDIUM)
- CVE-2026-15779 (libtdb1 2:1.4.13+samba4.22.11+dfsg-0+deb13u1, MEDIUM)
- CVE-2026-15779 (libtevent0t64 2:0.16.2+samba4.22.11+dfsg-0+deb13u1, MEDIUM)
...
- CVE-2026-15779 (libwbclient0 2:4.22.11+dfsg-0+deb13u1, MEDIUM)
...
- CVE-2011-4116 (perl-base 5.40.1-6+deb13u1, LOW)
- CVE-2026-15534 (perl-base 5.40.1-6+deb13u1, MEDIUM)
- CVE-2026-19487 (perl-base 5.40.1-6+deb13u1, MEDIUM)
- CVE-2026-82560 (perl-base 5.40.1-6+deb13u1, UNKNOWN)
- CVE-2026-9538 (perl-base 5.40.1-6+deb13u1, HIGH)
- CVE-2011-4116 (perl-modules-5.40 5.40.1-6+deb13u1, LOW)
- CVE-2026-15534 (perl-modules-5.40 5.40.1-6+deb13u1, MEDIUM)
- CVE-2026-19487 (perl-modules-5.40 5.40.1-6+deb13u1, MEDIUM)
- CVE-2026-82560 (perl-modules-5.40 5.40.1-6+deb13u1, UNKNOWN)
- CVE-2026-9538 (perl-modules-5.40 5.40.1-6+deb13u1, HIGH)
- CVE-2011-4116 (perl 5.40.1-6+deb13u1, LOW)
- CVE-2026-15534 (perl 5.40.1-6+deb13u1, MEDIUM)
- CVE-2026-19487 (perl 5.40.1-6+deb13u1, MEDIUM)
- CVE-2026-82560 (perl 5.40.1-6+deb13u1, UNKNOWN)
- CVE-2026-9538 (perl 5.40.1-6+deb13u1, HIGH)
- CVE-2025-12781 (python3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-15366 (python3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-15367 (python3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-12003 (python3.13-minimal 3.13.5-2+deb13u5, LOW)
- CVE-2026-15308 (python3.13-minimal 3.13.5-2+deb13u5, HIGH)
- CVE-2026-15310 (python3.13-minimal 3.13.5-2+deb13u5, LOW)
- CVE-2026-15806 (python3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-17084 (python3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-18503 (python3.13-minimal 3.13.5-2+deb13u5, LOW)
- CVE-2026-19672 (python3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-3479 (python3.13-minimal 3.13.5-2+deb13u5, LOW)
- CVE-2026-7210 (python3.13-minimal 3.13.5-2+deb13u5, HIGH)
- CVE-2026-82049 (python3.13-minimal 3.13.5-2+deb13u5, HIGH)
- CVE-2026-87910 (python3.13-minimal 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-12781 (python3.13 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-15366 (python3.13 3.13.5-2+deb13u5, MEDIUM)
- CVE-2025-15367 (python3.13 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-12003 (python3.13 3.13.5-2+deb13u5, LOW)
- CVE-2026-15308 (python3.13 3.13.5-2+deb13u5, HIGH)
- CVE-2026-15310 (python3.13 3.13.5-2+deb13u5, LOW)
- CVE-2026-15806 (python3.13 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-17084 (python3.13 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-18503 (python3.13 3.13.5-2+deb13u5, LOW)
- CVE-2026-19672 (python3.13 3.13.5-2+deb13u5, MEDIUM)
- CVE-2026-3479 (python3.13 3.13.5-2+deb13u5, LOW)
- CVE-2026-7210 (python3.13 3.13.5-2+deb13u5, HIGH)
- CVE-2026-82049 (python3.13 3.13.5-2+deb13u5, HIGH)
- CVE-2026-87910 (python3.13 3.13.5-2+deb13u5, MEDIUM)
...
- CVE-2026-15779 (samba-common 2:4.22.11+dfsg-0+deb13u1, MEDIUM)
- CVE-2026-15779 (samba-libs 2:4.22.11+dfsg-0+deb13u1, MEDIUM)
- CVE-2026-15779 (smbclient 2:4.22.11+dfsg-0+deb13u1, MEDIUM)
