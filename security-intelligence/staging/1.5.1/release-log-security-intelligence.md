...
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.33.0 |
| greenbone/asset-management-frontend | 1.32.0 |
...
| greenbone/opensight-notification-frontend | 1.13.0 |
...
| greenbone/management-console-frontend | 0.30.0 |
...
### management-console-frontend.v0.29.0
...
- CVE-2026-7009 (libcurl 8.19.0-r0, MEDIUM)
- CVE-2026-7168 (libcurl 8.19.0-r0, MEDIUM)
- GHSA-qwww-vcr4-c8h2 (react-router 7.18.0, HIGH)

### management-console-wst-server.v0.23.0
...
- CVE-2026-6368 (libc-bin 2.36-9+deb12u14, UNKNOWN)
- CVE-2026-6791 (libc-bin 2.36-9+deb12u14, UNKNOWN)
...
- CVE-2026-6368 (libc6 2.36-9+deb12u14, UNKNOWN)
- CVE-2026-6791 (libc6 2.36-9+deb12u14, UNKNOWN)
...
### opensight-notification-service-frontend.v1.12.0
...
### opensight-notification-service.v0.19.0
...
### vulnerability-intelligence-backend.v1.39.0

- GO-2026-5932 (golang.org/x/crypto v0.54.0, UNKNOWN)

### vulnerability-intelligence-frontend.v1.14.0
