...
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.27.0 |
| greenbone/asset-management-frontend | 1.26.0 |
| greenbone/opensight-postgres | 16.13.4 |
| greenbone/asset-management-browser | 0.0.8 |
| greenbone/opensight-keycloak | 27.2.0 |
| greenbone/opensight-opensearch | 2.21.0 |
| greenbone/opensight-ingress | 1.31.0 |
| greenbone/opensight-notification-service | 0.15.0 |
| greenbone/opensight-notification-frontend | 1.8.0 |
| greenbone/vulnerability-intelligence-backend | 1.36.0 |
| greenbone/vulnerability-intelligence-frontend | 1.10.0 |
| greenbone/management-console-backend | 0.18.0 |
| greenbone/user-management-frontend | 0.25.0 |
