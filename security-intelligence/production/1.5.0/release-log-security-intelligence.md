...
10. [greenbone/vulnerability-intelligence-backend](#greenbonevulnerability-intelligence-backend)
11. [greenbone/vulnerability-intelligence-frontend](#greenbonevulnerability-intelligence-frontend)
...
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.32.0 |
| greenbone/asset-management-frontend | 1.31.0 |
| greenbone/opensight-postgres | 17.10.5 |
| greenbone/asset-management-browser | 0.0.8 |
...
| greenbone/vulnerability-intelligence-frontend | 1.14.0 |
| greenbone/management-console-backend | 0.32.0 |
| greenbone/management-console-frontend | 0.29.0 |
| greenbone/websocket-tunnel | 0.23.0 |
...
### Version 1.28.1-alpha9

#### Bug Fixes
* Non admin can see system tags in asset list (#2080) [8c8e25fb](https://github.com/greenbone/asset-management-backend/commit/8c8e25fb)

[1.28.1-alpha9]: https://github.com/greenbone/asset-management-backend/compare/v1.28.1-alpha8...v1.28.1-alpha9


### Version 1.28.1-alpha8

#### Bug Fixes
* CSV download was not aware of the user context (#2079) [ed3853ce](https://github.com/greenbone/asset-management-backend/commit/ed3853ce)

[1.28.1-alpha8]: https://github.com/greenbone/asset-management-backend/compare/v1.28.1-alpha7...v1.28.1-alpha8


### Version 1.28.1-alpha7

[1.28.1-alpha7]: https://github.com/greenbone/asset-management-backend/compare/v1.28.1-alpha6...v1.28.1-alpha7
...
[1.28.1-alpha6]: https://github.com/greenbone/asset-management-backend/compare/v1.28.1-alpha5...v1.28.1-alpha6


### Version 1.28.1-alpha5

[1.28.1-alpha5]: https://github.com/greenbone/asset-management-backend/compare/v1.28.1-alpha4...v1.28.1-alpha5


### Version 1.28.1-alpha4

[1.28.1-alpha4]: https://github.com/greenbone/asset-management-backend/compare/v1.28.1-alpha3...v1.28.1-alpha4


### Version 1.28.1-alpha3

[1.28.1-alpha3]: https://github.com/greenbone/asset-management-backend/compare/v1.28.1-alpha2...v1.28.1-alpha3


### Version 1.28.1-alpha2

[1.28.1-alpha2]: https://github.com/greenbone/asset-management-backend/compare/v1.28.1-alpha1...v1.28.1-alpha2
...
[1.28.1-alpha1]: https://github.com/greenbone/asset-management-backend/compare/v1.28.0...v1.28.1-alpha1


### Version 1.28.0

#### Added
* CRUD endpoints for tagPermissions (#2019) [eb7d455e](https://github.com/greenbone/asset-management-backend/commit/eb7d455e)

#### Changed
* add new roles to endpoints (#2052) [4ee874e4](https://github.com/greenbone/asset-management-backend/commit/4ee874e4)
* remove test data controller (#2048) [667d38c5](https://github.com/greenbone/asset-management-backend/commit/667d38c5)

#### Bug Fixes
* Ingestor workers owns one source. (#2059) [096cd30c](https://github.com/greenbone/asset-management-backend/commit/096cd30c)
* fix required (nested) roles for read `tags` endoints (#2055) [8a0d3a83](https://github.com/greenbone/asset-management-backend/commit/8a0d3a83)

[1.28.0]: https://github.com/greenbone/asset-management-backend/compare/v1.27.0...v1.28.0


### Version 1.27.1-alpha14

#### Bug Fixes
* Ingestor workers owns one source. (#2059) [096cd30c](https://github.com/greenbone/asset-management-backend/commit/096cd30c)

[1.27.1-alpha14]: https://github.com/greenbone/asset-management-backend/compare/v1.27.1-alpha13...v1.27.1-alpha14


### Version 1.27.1-alpha13

[1.27.1-alpha13]: https://github.com/greenbone/asset-management-backend/compare/v1.27.1-alpha12...v1.27.1-alpha13
...
[1.26.1-alpha2]: https://github.com/greenbone/asset-management-frontend/compare/v1.26.1-alpha1...v1.26.1-alpha2
...
[1.26.1-alpha1]: https://github.com/greenbone/asset-management-frontend/compare/v1.26.0...v1.26.1-alpha1


### Version 1.26.0

#### Added
* feature flag to hide tag permissions and skip tests [93265e0b](https://github.com/greenbone/asset-management-frontend/commit/93265e0b)

[1.26.0]: https://github.com/greenbone/asset-management-frontend/compare/v1.25.0...v1.26.0


### Version 1.25.0

[1.25.0]: https://github.com/greenbone/asset-management-frontend/compare/v1.24.0...v1.25.0


### Version 1.24.0

#### Added
* notification toast upon success or failure [03eb95f6](https://github.com/greenbone/asset-management-frontend/commit/03eb95f6)
* AGENTS.md to support AI development and documentation [911e0e2c](https://github.com/greenbone/asset-management-frontend/commit/911e0e2c)
* translations [9127076c](https://github.com/greenbone/asset-management-frontend/commit/9127076c)
* basic mock api setup [ec2ac42f](https://github.com/greenbone/asset-management-frontend/commit/ec2ac42f)

#### Removed
* tagging rules feature flag [e97d4146](https://github.com/greenbone/asset-management-frontend/commit/e97d4146)

#### Changed
* menu points (#1781) [e0219a0e](https://github.com/greenbone/asset-management-frontend/commit/e0219a0e)
* remove first name and last name from user api [08caff92](https://github.com/greenbone/asset-management-frontend/commit/08caff92)
* improve validation logic for group and user inputs [b647cf45](https://github.com/greenbone/asset-management-frontend/commit/b647cf45)
* fix service test [2e7bcc02](https://github.com/greenbone/asset-management-frontend/commit/2e7bcc02)
* Tag permissions to use new tag structure in tag permissions service [653b71a0](https://github.com/greenbone/asset-management-frontend/commit/653b71a0)
* code owners [571d3984](https://github.com/greenbone/asset-management-frontend/commit/571d3984)
* use esm imports for cypress [acfe6186](https://github.com/greenbone/asset-management-frontend/commit/acfe6186)
* update service tests [54bfbb10](https://github.com/greenbone/asset-management-frontend/commit/54bfbb10)
* fix service tests [7085d526](https://github.com/greenbone/asset-management-frontend/commit/7085d526)
* add id to groups in tag permissions [c10980e5](https://github.com/greenbone/asset-management-frontend/commit/c10980e5)

[1.24.0]: https://github.com/greenbone/asset-management-frontend/compare/v1.23.0...v1.24.0


### Version 1.23.1-alpha2

#### Changed
* remove first name and last name from user api [08caff92](https://github.com/greenbone/asset-management-frontend/commit/08caff92)

[1.23.1-alpha2]: https://github.com/greenbone/asset-management-frontend/compare/v1.23.1-alpha1...v1.23.1-alpha2


### Version 1.23.1-alpha1
...
[1.23.1-alpha1]: https://github.com/greenbone/asset-management-frontend/compare/v1.23.0...v1.23.1-alpha1


### Version 1.23.0

[1.23.0]: https://github.com/greenbone/asset-management-frontend/compare/v1.22.0...v1.23.0
...
### Version 0.25.1-alpha4

[0.25.1-alpha4]: https://github.com/greenbone/management-console-backend/compare/v0.25.1-alpha3...v0.25.1-alpha4

#### Added
- Reinstate issuer verification (https://github.com/greenbone/management-console-backend/pull/658)
...
[0.20.1-alpha5]: https://github.com/greenbone/management-console-frontend/compare/v0.20.1-alpha4...v0.20.1-alpha5


### Version 0.20.1-alpha4

#### Added
* Inform user when the support package will be deleted (#980) [d68c8b3](https://github.com/greenbone/management-console-frontend/commit/d68c8b3)

[0.20.1-alpha4]: https://github.com/greenbone/management-console-frontend/compare/v0.20.1-alpha3...v0.20.1-alpha4


### Version 0.20.1-alpha3

#### Bug Fixes
* add german translation for selfcheck start. (#992) [cddfb79](https://github.com/greenbone/management-console-frontend/commit/cddfb79)

[0.20.1-alpha3]: https://github.com/greenbone/management-console-frontend/compare/v0.20.1-alpha2...v0.20.1-alpha3
...
[0.13.1-alpha2]: https://github.com/greenbone/websocket-tunnel/compare/v0.13.1-alpha1...v0.13.1-alpha2



## Fixed CVEs

### asset-management-backend.v1.28.0

- GO-2026-5932 (golang.org/x/crypto v0.52.0, UNKNOWN)
- CVE-2026-46600 (golang.org/x/net v0.55.0, UNKNOWN)
- CVE-2026-56852 (golang.org/x/text v0.37.0, UNKNOWN)
- CVE-2026-39822 (stdlib v1.26.4, HIGH)
- CVE-2026-42505 (stdlib v1.26.4, MEDIUM)

### asset-management-frontend.v1.27.0

- CVE-2026-33630 (c-ares 1.34.6-r0, HIGH)
- CVE-2026-4873 (curl 8.19.0-r0, MEDIUM)
- CVE-2026-5545 (curl 8.19.0-r0, MEDIUM)
- CVE-2026-5773 (curl 8.19.0-r0, HIGH)
- CVE-2026-6253 (curl 8.19.0-r0, MEDIUM)
- CVE-2026-6276 (curl 8.19.0-r0, HIGH)
- CVE-2026-6429 (curl 8.19.0-r0, MEDIUM)
- CVE-2026-7009 (curl 8.19.0-r0, MEDIUM)
- CVE-2026-7168 (curl 8.19.0-r0, MEDIUM)
- CVE-2026-4873 (libcurl 8.19.0-r0, MEDIUM)
- CVE-2026-5545 (libcurl 8.19.0-r0, MEDIUM)
- CVE-2026-5773 (libcurl 8.19.0-r0, HIGH)
- CVE-2026-6253 (libcurl 8.19.0-r0, MEDIUM)
- CVE-2026-6276 (libcurl 8.19.0-r0, HIGH)
- CVE-2026-6429 (libcurl 8.19.0-r0, MEDIUM)
- CVE-2026-7009 (libcurl 8.19.0-r0, MEDIUM)
- CVE-2026-7168 (libcurl 8.19.0-r0, MEDIUM)
- CVE-2026-41080 (libexpat 2.7.5-r0, LOW)
- CVE-2026-45186 (libexpat 2.7.5-r0, HIGH)
- CVE-2026-50219 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56131 (libexpat 2.7.5-r0, HIGH)
- CVE-2026-56132 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56403 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56404 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56405 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56406 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56407 (libexpat 2.7.5-r0, HIGH)
- CVE-2026-56408 (libexpat 2.7.5-r0, HIGH)
- CVE-2026-56409 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56410 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56411 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56412 (libexpat 2.7.5-r0, MEDIUM)

### management-console-backend.v0.28.0
...
- CVE-2026-6472 (libpq5 17.9-0+deb13u1, MEDIUM)
- CVE-2026-6473 (libpq5 17.9-0+deb13u1, HIGH)
- CVE-2026-6474 (libpq5 17.9-0+deb13u1, MEDIUM)
- CVE-2026-6475 (libpq5 17.9-0+deb13u1, MEDIUM)
- CVE-2026-6476 (libpq5 17.9-0+deb13u1, HIGH)
- CVE-2026-6477 (libpq5 17.9-0+deb13u1, HIGH)
- CVE-2026-6478 (libpq5 17.9-0+deb13u1, HIGH)
- CVE-2026-6479 (libpq5 17.9-0+deb13u1, HIGH)
- CVE-2026-6637 (libpq5 17.9-0+deb13u1, HIGH)
- CVE-2026-6638 (libpq5 17.9-0+deb13u1, HIGH)
...
### management-console-frontend.v0.26.0
...
- CVE-2026-56411 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-56412 (libexpat 2.7.5-r0, MEDIUM)
- CVE-2026-53666 (react-router 7.16.0, MEDIUM)
- CVE-2026-53667 (react-router 7.16.0, MEDIUM)
- CVE-2026-53669 (react-router 7.16.0, MEDIUM)
- CVE-2026-55685 (react-router 7.16.0, HIGH)
- GHSA-qwww-vcr4-c8h2 (react-router 7.16.0, HIGH)

### management-console-wst-server.v0.21.0
...
- CVE-2026-50185 (cmov 0.5.3, MEDIUM)
...
- CVE-2026-60005 (nginx 1.31.1-1~trixie, MEDIUM)
...
- GHSA-mfg7-5gfp-c4w3 (io.netty:netty-codec-dns 4.1.133.Final, MEDIUM)
...
### opensight-notification-service-frontend.v1.9.0
...
### opensight-notification-service.v0.16.0

- GO-2026-5932 (golang.org/x/crypto v0.53.0, UNKNOWN)
- CVE-2026-56852 (golang.org/x/text v0.38.0, UNKNOWN)
- CVE-2026-39822 (stdlib v1.26.4, HIGH)
- CVE-2026-42505 (stdlib v1.26.4, MEDIUM)

### opensight-opensearch.v2.21.0

- CVE-2026-59949 (at.yawk.lz4:lz4-java 1.10.1, MEDIUM)
- GHSA-72hv-8253-57qq (com.fasterxml.jackson.core:jackson-core 2.18.2, MEDIUM)
- GHSA-r7wm-3cxj-wff9 (com.fasterxml.jackson.core:jackson-core 2.18.2, HIGH)
- CVE-2026-54512 (com.fasterxml.jackson.core:jackson-databind 2.14.1, HIGH)
- CVE-2026-54513 (com.fasterxml.jackson.core:jackson-databind 2.14.1, HIGH)
- CVE-2026-54514 (com.fasterxml.jackson.core:jackson-databind 2.14.1, MEDIUM)
- CVE-2026-54515 (com.fasterxml.jackson.core:jackson-databind 2.14.1, MEDIUM)
- CVE-2026-54512 (com.fasterxml.jackson.core:jackson-databind 2.17.1, HIGH)
- CVE-2026-54513 (com.fasterxml.jackson.core:jackson-databind 2.17.1, HIGH)
- CVE-2026-54514 (com.fasterxml.jackson.core:jackson-databind 2.17.1, MEDIUM)
- CVE-2026-54515 (com.fasterxml.jackson.core:jackson-databind 2.17.1, MEDIUM)
- CVE-2026-59888 (com.fasterxml.jackson.core:jackson-databind 2.17.1, MEDIUM)
- CVE-2026-54512 (com.fasterxml.jackson.core:jackson-databind 2.18.2, HIGH)
- CVE-2026-54513 (com.fasterxml.jackson.core:jackson-databind 2.18.2, HIGH)
- CVE-2026-54514 (com.fasterxml.jackson.core:jackson-databind 2.18.2, MEDIUM)
- CVE-2026-54515 (com.fasterxml.jackson.core:jackson-databind 2.18.2, MEDIUM)
- CVE-2026-59888 (com.fasterxml.jackson.core:jackson-databind 2.18.2, MEDIUM)
- CVE-2026-59889 (com.fasterxml.jackson.core:jackson-databind 2.18.2, MEDIUM)
- GHSA-mhm7-754m-9p8w (com.fasterxml.jackson.core:jackson-databind 2.18.2, MEDIUM)
- CVE-2026-3805 (curl-minimal 8.17.0-1.amzn2023.0.1, MEDIUM)
- CVE-2026-56132 (expat 2.6.3-1.amzn2023.0.4, HIGH)
- CVE-2026-56403 (expat 2.6.3-1.amzn2023.0.4, HIGH)
- CVE-2026-56406 (expat 2.6.3-1.amzn2023.0.4, HIGH)
- CVE-2026-56407 (expat 2.6.3-1.amzn2023.0.4, HIGH)
- CVE-2026-58010 (glib2 2.82.2-769.amzn2023, HIGH)
- CVE-2026-58011 (glib2 2.82.2-769.amzn2023, HIGH)
- CVE-2026-58012 (glib2 2.82.2-769.amzn2023, HIGH)
- CVE-2026-58013 (glib2 2.82.2-769.amzn2023, HIGH)
- CVE-2026-58014 (glib2 2.82.2-769.amzn2023, HIGH)
- CVE-2026-58015 (glib2 2.82.2-769.amzn2023, HIGH)
- CVE-2026-58016 (glib2 2.82.2-769.amzn2023, HIGH)
- CVE-2026-4046 (glibc-common 2.34-231.amzn2023.0.3, HIGH)
- CVE-2026-4046 (glibc-minimal-langpack 2.34-231.amzn2023.0.3, HIGH)
- CVE-2026-4046 (glibc 2.34-231.amzn2023.0.3, HIGH)
- CVE-2026-57062 (gnupg2-minimal 2.3.7-1.amzn2023.0.7, LOW)
- CVE-2026-33871 (io.netty:netty-codec-http2 4.1.125.Final, HIGH)
- CVE-2026-42587 (io.netty:netty-codec-http2 4.1.125.Final, HIGH)
- CVE-2026-47244 (io.netty:netty-codec-http2 4.1.125.Final, MEDIUM)
- CVE-2026-48043 (io.netty:netty-codec-http2 4.1.125.Final, MEDIUM)
- CVE-2026-50560 (io.netty:netty-codec-http2 4.1.125.Final, MEDIUM)
- CVE-2026-59900 (io.netty:netty-codec-http2 4.1.125.Final, MEDIUM)
- CVE-2026-33871 (io.netty:netty-codec-http2 4.1.131.Final, HIGH)
- CVE-2026-42587 (io.netty:netty-codec-http2 4.1.131.Final, HIGH)
- CVE-2026-47244 (io.netty:netty-codec-http2 4.1.131.Final, MEDIUM)
- CVE-2026-48043 (io.netty:netty-codec-http2 4.1.131.Final, MEDIUM)
- CVE-2026-50560 (io.netty:netty-codec-http2 4.1.131.Final, MEDIUM)
- CVE-2026-59900 (io.netty:netty-codec-http2 4.1.131.Final, MEDIUM)
- CVE-2025-67735 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-33870 (io.netty:netty-codec-http 4.1.125.Final, HIGH)
- CVE-2026-41417 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-42580 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-42581 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-42584 (io.netty:netty-codec-http 4.1.125.Final, HIGH)
- CVE-2026-42585 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-42587 (io.netty:netty-codec-http 4.1.125.Final, HIGH)
- CVE-2026-50020 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-55831 (io.netty:netty-codec-http 4.1.125.Final, HIGH)
- CVE-2026-55833 (io.netty:netty-codec-http 4.1.125.Final, HIGH)
- CVE-2026-56745 (io.netty:netty-codec-http 4.1.125.Final, HIGH)
- CVE-2026-56746 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-59898 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-59899 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-59921 (io.netty:netty-codec-http 4.1.125.Final, MEDIUM)
- CVE-2026-33870 (io.netty:netty-codec-http 4.1.131.Final, HIGH)
- CVE-2026-41417 (io.netty:netty-codec-http 4.1.131.Final, MEDIUM)
- CVE-2026-42580 (io.netty:netty-codec-http 4.1.131.Final, MEDIUM)
- CVE-2026-42581 (io.netty:netty-codec-http 4.1.131.Final, MEDIUM)
- CVE-2026-42584 (io.netty:netty-codec-http 4.1.131.Final, HIGH)
- CVE-2026-42585 (io.netty:netty-codec-http 4.1.131.Final, MEDIUM)
- CVE-2026-42587 (io.netty:netty-codec-http 4.1.131.Final, HIGH)
- CVE-2026-50020 (io.netty:netty-codec-http 4.1.131.Final, MEDIUM)
- CVE-2026-55831 (io.netty:netty-codec-http 4.1.131.Final, HIGH)
- CVE-2026-55833 (io.netty:netty-codec-http 4.1.131.Final, HIGH)
- CVE-2026-56745 (io.netty:netty-codec-http 4.1.131.Final, HIGH)
- CVE-2026-56746 (io.netty:netty-codec-http 4.1.131.Final, MEDIUM)
- CVE-2026-59898 (io.netty:netty-codec-http 4.1.131.Final, MEDIUM)
- CVE-2026-59899 (io.netty:netty-codec-http 4.1.131.Final, MEDIUM)
- CVE-2026-59921 (io.netty:netty-codec-http 4.1.131.Final, MEDIUM)
- CVE-2026-42583 (io.netty:netty-codec 4.1.125.Final, HIGH)
- CVE-2026-59901 (io.netty:netty-codec 4.1.125.Final, HIGH)
- CVE-2026-42583 (io.netty:netty-codec 4.1.131.Final, HIGH)
- CVE-2026-59901 (io.netty:netty-codec 4.1.131.Final, HIGH)
- CVE-2026-42578 (io.netty:netty-handler-proxy 4.1.131.Final, LOW)
- CVE-2026-44249 (io.netty:netty-handler 4.1.125.Final, HIGH)
- CVE-2026-45416 (io.netty:netty-handler 4.1.125.Final, HIGH)
- CVE-2026-50010 (io.netty:netty-handler 4.1.125.Final, HIGH)
- CVE-2026-44249 (io.netty:netty-handler 4.1.131.Final, HIGH)
- CVE-2026-45416 (io.netty:netty-handler 4.1.131.Final, HIGH)
- CVE-2026-50010 (io.netty:netty-handler 4.1.131.Final, HIGH)
- CVE-2026-11850 (krb5-libs 1.21.3-6.amzn2023.0.1, MEDIUM)
- CVE-2026-40355 (krb5-libs 1.21.3-6.amzn2023.0.1, MEDIUM)
- CVE-2026-40356 (krb5-libs 1.21.3-6.amzn2023.0.1, MEDIUM)
- CVE-2026-54369 (libacl 2.3.1-2.amzn2023.0.2, HIGH)
- CVE-2026-54370 (libacl 2.3.1-2.amzn2023.0.2, HIGH)
- CVE-2026-53615 (libblkid 2.37.4-1.amzn2023.0.4, HIGH)
- CVE-2026-27142 (libcap 2.73-1.amzn2023.0.6, HIGH)
- CVE-2026-33811 (libcap 2.73-1.amzn2023.0.6, HIGH)
- CVE-2026-33814 (libcap 2.73-1.amzn2023.0.6, HIGH)
- CVE-2026-39820 (libcap 2.73-1.amzn2023.0.6, HIGH)
- CVE-2026-39823 (libcap 2.73-1.amzn2023.0.6, HIGH)
- CVE-2026-42499 (libcap 2.73-1.amzn2023.0.6, HIGH)
- CVE-2026-3805 (libcurl-minimal 8.17.0-1.amzn2023.0.1, MEDIUM)
- CVE-2026-41989 (libgcrypt 1.10.2-1.amzn2023.0.2, MEDIUM)
- CVE-2026-53615 (libmount 2.37.4-1.amzn2023.0.4, HIGH)
- CVE-2026-27135 (libnghttp2 1.59.0-3.amzn2023.0.1, HIGH)
- CVE-2026-53615 (libsmartcols 2.37.4-1.amzn2023.0.4, HIGH)
- CVE-2026-48863 (libsolv 0.7.22-1.amzn2023.0.2, HIGH)
- CVE-2026-48864 (libsolv 0.7.22-1.amzn2023.0.2, HIGH)
- CVE-2026-9149 (libsolv 0.7.22-1.amzn2023.0.2, HIGH)
- CVE-2026-9150 (libsolv 0.7.22-1.amzn2023.0.2, HIGH)
- CVE-2026-53615 (libuuid 2.37.4-1.amzn2023.0.4, HIGH)
- CVE-2026-6653 (libxml2 2.10.4-1.amzn2023.0.18, MEDIUM)
- CVE-2026-2673 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, LOW)
- CVE-2026-28387 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-28388 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-28389 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-28390 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-31790 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34180 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34181 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34182 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34183 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42764 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42766 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42767 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42768 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42769 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42770 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-45445 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-45446 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-45447 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-7383 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-9076 (openssl-fips-provider-latest 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-2673 (openssl-libs 1:3.2.2-1.amzn2023.0.5, LOW)
- CVE-2026-28387 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-28388 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-28389 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-28390 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-31790 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34180 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34181 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34182 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34183 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42764 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42766 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42767 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42768 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42769 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42770 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-45445 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-45446 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-45447 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-7383 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-9076 (openssl-libs 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-2673 (openssl 1:3.2.2-1.amzn2023.0.5, LOW)
- CVE-2026-28387 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-28388 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-28389 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-28390 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-31790 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34180 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34181 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34182 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-34183 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42764 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42766 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42767 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42768 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42769 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-42770 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-45445 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-45446 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-45447 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-7383 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-9076 (openssl 1:3.2.2-1.amzn2023.0.5, HIGH)
- CVE-2026-33558 (org.apache.kafka:kafka-clients 3.9.1, MEDIUM)
- CVE-2026-35554 (org.apache.kafka:kafka-clients 3.9.1, HIGH)
- CVE-2026-34477 (org.apache.logging.log4j:log4j-core 2.25.3, MEDIUM)
- CVE-2026-34478 (org.apache.logging.log4j:log4j-core 2.25.3, MEDIUM)
- CVE-2026-34480 (org.apache.logging.log4j:log4j-core 2.25.3, MEDIUM)
- CVE-2025-54920 (org.apache.spark:spark-core_2.13 3.5.4, HIGH)
- CVE-2026-5588 (org.bouncycastle:bcpkix-jdk15to18 1.79, MEDIUM)
- CVE-2026-5588 (org.bouncycastle:bcpkix-jdk18on 1.79, MEDIUM)
- CVE-2026-5588 (org.bouncycastle:bcpkix-jdk18on 1.82, MEDIUM)
- CVE-2025-14813 (org.bouncycastle:bcprov-jdk15to18 1.78.1, CRITICAL)
- CVE-2026-0636 (org.bouncycastle:bcprov-jdk15to18 1.78.1, MEDIUM)
- CVE-2026-5598 (org.bouncycastle:bcprov-jdk15to18 1.78.1, HIGH)
- CVE-2025-14813 (org.bouncycastle:bcprov-jdk15to18 1.79, CRITICAL)
- CVE-2026-0636 (org.bouncycastle:bcprov-jdk15to18 1.79, MEDIUM)
- CVE-2026-5598 (org.bouncycastle:bcprov-jdk15to18 1.79, HIGH)
- CVE-2025-14813 (org.bouncycastle:bcprov-jdk18on 1.80, CRITICAL)
- CVE-2026-0636 (org.bouncycastle:bcprov-jdk18on 1.80, MEDIUM)
- CVE-2025-14813 (org.bouncycastle:bcprov-jdk18on 1.82, CRITICAL)
- CVE-2026-0636 (org.bouncycastle:bcprov-jdk18on 1.82, MEDIUM)
- CVE-2026-5598 (org.bouncycastle:bcprov-jdk18on 1.82, HIGH)
- CVE-2026-10050 (org.eclipse.jetty:jetty-security 9.4.56.v20240826, HIGH)
- CVE-2025-11468 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2025-13462 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2025-15282 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-0672 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-0864 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-0865 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-11940 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-11972 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-1299 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-2297 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-3276 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-3446 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-3479 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-3644 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-4224 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-4519 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-4786 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-6019 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-6100 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-7210 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-8328 (python3-libs 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-9669 (python3-libs 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-1703 (python3-pip-wheel 21.3.1-2.amzn2023.0.16, LOW)
- CVE-2026-6357 (python3-pip-wheel 21.3.1-2.amzn2023.0.16, HIGH)
- CVE-2026-8643 (python3-pip-wheel 21.3.1-2.amzn2023.0.16, HIGH)
- CVE-2025-11468 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2025-13462 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2025-15282 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-0672 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-0864 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-0865 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-11940 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-11972 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-1299 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-2297 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-3276 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-3446 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-3479 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-3644 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-4224 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-4519 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-4786 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-6019 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-6100 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-7210 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-8328 (python3 3.9.25-1.amzn2023.0.3, MEDIUM)
- CVE-2026-9669 (python3 3.9.25-1.amzn2023.0.3, HIGH)
- CVE-2026-11822 (sqlite-libs 3.40.0-1.amzn2023.0.7, HIGH)
- CVE-2026-11824 (sqlite-libs 3.40.0-1.amzn2023.0.7, HIGH)

### opensight-postgres.16.14.1
...
- CVE-2026-53614 (util-linux 2.41-5, UNKNOWN)
- CVE-2026-53615 (util-linux 2.41-5, HIGH)
- CVE-2026-34743 (xz-utils 5.8.1-1, MEDIUM)
- CVE-2026-27171 (zlib1g 1:1.3.dfsg+really1.3.1-1+b1, MEDIUM)

### opensight-postgres.17.10.1
...
- CVE-2026-8458 (libcurl 8.20.0-r1, LOW)
...
- CVE-2026-8932 (libcurl 8.20.0-r1, HIGH)
- CVE-2026-9079 (libcurl 8.20.0-r1, HIGH)
- CVE-2026-9080 (libcurl 8.20.0-r1, HIGH)
- CVE-2026-9545 (libcurl 8.20.0-r1, HIGH)
- CVE-2026-9546 (libcurl 8.20.0-r1, HIGH)
- CVE-2026-9547 (libcurl 8.20.0-r1, HIGH)
- CVE-2026-50219 (libexpat 2.8.1-r0, MEDIUM)
- CVE-2026-56131 (libexpat 2.8.1-r0, HIGH)
...
- CVE-2026-56407 (libexpat 2.8.1-r0, HIGH)
...
### vulnerability-intelligence-dmz-proxy.v1.37.0
...
### vulnerability-intelligence-frontend.v1.11.0
