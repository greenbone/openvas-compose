...
11. [greenbone/management-console-backend](#greenbonemanagement-console-backend)
12. [greenbone/management-console-frontend](#greenbonemanagement-console-frontend)
13. [greenbone/websocket-tunnel](#greenbonewebsocket-tunnel)


## Current Services
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.38.0 |
| greenbone/asset-management-frontend | 1.35.0 |
| greenbone/opensight-postgres | 17.11.1 |
| greenbone/opensight-keycloak | 27.9.0 |
| greenbone/opensight-opensearch | 2.22.0 |
| greenbone/opensight-ingress | 1.33.0 |
| greenbone/opensight-notification-service | 0.22.0 |
| greenbone/opensight-notification-frontend | 1.16.0 |
| greenbone/vulnerability-intelligence-backend | 1.42.0 |
| greenbone/vulnerability-intelligence-frontend | 1.18.0 |
| greenbone/management-console-backend | 0.34.0 |
| greenbone/management-console-frontend | 0.33.0 |
...
### asset-management-backend.v1.34.0

- CVE-2026-56854 (golang.org/x/crypto v0.54.0, HIGH)
- CVE-2026-56855 (golang.org/x/crypto v0.54.0, MEDIUM)
- CVE-2026-78662 (golang.org/x/crypto v0.54.0, MEDIUM)
- GO-2026-5932 (golang.org/x/crypto v0.54.0, UNKNOWN)
- CVE-2026-56864 (golang.org/x/mod v0.38.0, HIGH)
- CVE-2026-56865 (golang.org/x/mod v0.38.0, HIGH)
...
### asset-management-frontend.v1.33.0

- CVE-2026-13608 (curl 8.21.0-r0, MEDIUM)
- CVE-2026-18924 (curl 8.21.0-r0, MEDIUM)
- CVE-2026-19931 (curl 8.21.0-r0, MEDIUM)
- CVE-2026-80229 (curl 8.21.0-r0, MEDIUM)
- CVE-2026-80230 (curl 8.21.0-r0, MEDIUM)
- CVE-2026-80231 (curl 8.21.0-r0, UNKNOWN)
- CVE-2026-80255 (curl 8.21.0-r0, MEDIUM)
- CVE-2026-80256 (curl 8.21.0-r0, UNKNOWN)
- CVE-2026-82208 (curl 8.21.0-r0, UNKNOWN)
- CVE-2026-82209 (curl 8.21.0-r0, MEDIUM)
...
- CVE-2026-75803 (libcrypto3 3.5.7-r0, MEDIUM)
- CVE-2026-13608 (libcurl 8.21.0-r0, MEDIUM)
- CVE-2026-18924 (libcurl 8.21.0-r0, MEDIUM)
- CVE-2026-19931 (libcurl 8.21.0-r0, MEDIUM)
- CVE-2026-80229 (libcurl 8.21.0-r0, MEDIUM)
- CVE-2026-80230 (libcurl 8.21.0-r0, MEDIUM)
- CVE-2026-80231 (libcurl 8.21.0-r0, UNKNOWN)
- CVE-2026-80255 (libcurl 8.21.0-r0, MEDIUM)
- CVE-2026-80256 (libcurl 8.21.0-r0, UNKNOWN)
- CVE-2026-82208 (libcurl 8.21.0-r0, UNKNOWN)
- CVE-2026-82209 (libcurl 8.21.0-r0, MEDIUM)
- CVE-2026-66046 (libexpat 2.8.2-r0, HIGH)
- CVE-2026-76641 (libexpat 2.8.2-r0, MEDIUM)
- CVE-2026-76956 (libexpat 2.8.2-r0, HIGH)
- CVE-2026-76957 (libexpat 2.8.2-r0, HIGH)
...
- CVE-2026-75803 (libssl3 3.5.7-r0, MEDIUM)
- CVE-2026-53612 (libuuid 2.42.1-r0, HIGH)
- CVE-2026-53613 (libuuid 2.42.1-r0, HIGH)
- CVE-2026-53614 (libuuid 2.42.1-r0, HIGH)
- CVE-2026-76642 (libuuid 2.42.1-r0, HIGH)
- CVE-2026-78408 (libuuid 2.42.1-r0, HIGH)
- CVE-2026-78409 (libuuid 2.42.1-r0, HIGH)
- CVE-2026-78410 (libuuid 2.42.1-r0, HIGH)

### management-console-backend.v0.32.0
...
- CVE-2026-73228 (djangorestframework 3.17.1, MEDIUM)
- CVE-2026-73229 (djangorestframework 3.17.1, MEDIUM)
...
- CVE-2026-75803 (libssl3t64 3.5.6-1~deb13u2, MEDIUM)
...
- CVE-2026-75803 (openssl-provider-legacy 3.5.6-1~deb13u2, MEDIUM)
...
- CVE-2026-75803 (openssl 3.5.6-1~deb13u2, MEDIUM)
...
- CVE-2025-8869 (pip 25.0.1, MEDIUM)
- CVE-2026-13346 (pip 25.0.1, MEDIUM)
- CVE-2026-1703 (pip 25.0.1, LOW)
- CVE-2026-3219 (pip 25.0.1, MEDIUM)
- CVE-2026-6357 (pip 25.0.1, MEDIUM)
- CVE-2026-8643 (pip 25.0.1, MEDIUM)
- CVE-2026-54284 (sqlparse 0.5.5, HIGH)
- CVE-2026-59893 (sqlparse 0.5.5, HIGH)
- CVE-2026-59894 (sqlparse 0.5.5, MEDIUM)
- CVE-2026-71491 (sqlparse 0.5.5, HIGH)
- CVE-2026-84305 (sqlparse 0.5.5, MEDIUM)
...
### management-console-frontend.v0.31.0
...
- CVE-2026-78409 (libuuid 2.42.1-r0, HIGH)
- CVE-2026-78410 (libuuid 2.42.1-r0, HIGH)
- CVE-2026-82417 (qs 6.15.3, MEDIUM)
- CVE-2026-82562 (qs 6.15.3, MEDIUM)
- GHSA-qwww-vcr4-c8h2 (react-router 7.18.1, HIGH)

### management-console-wst-server.v0.24.0

- CVE-2011-3374 (apt 2.6.1, LOW)
- TEMP-0841856-B18BAF (bash 5.2.15-2+b13, LOW)
...
- CVE-2026-53613 (bsdutils 1:2.38.1-5+deb12u3, HIGH)
- CVE-2026-53615 (bsdutils 1:2.38.1-5+deb12u3, MEDIUM)
- CVE-2026-76642 (bsdutils 1:2.38.1-5+deb12u3, HIGH)
- CVE-2026-78408 (bsdutils 1:2.38.1-5+deb12u3, HIGH)
- CVE-2026-78409 (bsdutils 1:2.38.1-5+deb12u3, HIGH)
- CVE-2026-78410 (bsdutils 1:2.38.1-5+deb12u3, HIGH)
...
- CVE-2022-3219 (gpgv 2.2.40-1.1+deb12u2, LOW)
- CVE-2025-30258 (gpgv 2.2.40-1.1+deb12u2, MEDIUM)
- CVE-2025-68972 (gpgv 2.2.40-1.1+deb12u2, MEDIUM)
- CVE-2026-57062 (gpgv 2.2.40-1.1+deb12u2, LOW)
...
- CVE-2026-53613 (libblkid1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-53615 (libblkid1 2.38.1-5+deb12u3, MEDIUM)
- CVE-2026-76642 (libblkid1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78408 (libblkid1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78409 (libblkid1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78410 (libblkid1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-42250 (libbz2-1.0 1.0.8-5+b1, MEDIUM)
- CVE-2010-4756 (libc-bin 2.36-9+deb12u14, LOW)
- CVE-2018-20796 (libc-bin 2.36-9+deb12u14, LOW)
- CVE-2019-1010022 (libc-bin 2.36-9+deb12u14, LOW)
- CVE-2019-1010023 (libc-bin 2.36-9+deb12u14, LOW)
- CVE-2019-1010024 (libc-bin 2.36-9+deb12u14, LOW)
- CVE-2019-1010025 (libc-bin 2.36-9+deb12u14, LOW)
- CVE-2019-9192 (libc-bin 2.36-9+deb12u14, LOW)
- CVE-2026-18374 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-19499 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-19542 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-5435 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-5450 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-5928 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-6238 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-6368 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-6791 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-77117 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-80489 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2026-89092 (libc-bin 2.36-9+deb12u14, MEDIUM)
- CVE-2010-4756 (libc6 2.36-9+deb12u14, LOW)
- CVE-2018-20796 (libc6 2.36-9+deb12u14, LOW)
- CVE-2019-1010022 (libc6 2.36-9+deb12u14, LOW)
- CVE-2019-1010023 (libc6 2.36-9+deb12u14, LOW)
- CVE-2019-1010024 (libc6 2.36-9+deb12u14, LOW)
- CVE-2019-1010025 (libc6 2.36-9+deb12u14, LOW)
- CVE-2019-9192 (libc6 2.36-9+deb12u14, LOW)
- CVE-2026-18374 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-19499 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-19542 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-5435 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-5450 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-5928 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-6238 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-6368 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-6791 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-77117 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-80489 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2026-89092 (libc6 2.36-9+deb12u14, MEDIUM)
- CVE-2022-27943 (libgcc-s1 12.2.0-14+deb12u1, LOW)
- CVE-2018-6829 (libgcrypt20 1.10.1-3+deb12u1, LOW)
- CVE-2024-2236 (libgcrypt20 1.10.1-3+deb12u1, LOW)
- CVE-2011-3389 (libgnutls30 3.7.9-2+deb12u7, LOW)
- TEMP-1147318-639065 (liblzma5 5.4.1-1+deb12u1, UNKNOWN)
...
- CVE-2026-53613 (libmount1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-53615 (libmount1 2.38.1-5+deb12u3, MEDIUM)
- CVE-2026-76642 (libmount1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78408 (libmount1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78409 (libmount1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78410 (libmount1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-13757 (libp11-kit0 0.24.1-2, MEDIUM)
- CVE-2026-18938 (libp11-kit0 0.24.1-2, MEDIUM)
- CVE-2024-10041 (libpam-modules-bin 1.5.2-6+deb12u2, MEDIUM)
- CVE-2026-54411 (libpam-modules-bin 1.5.2-6+deb12u2, MEDIUM)
- CVE-2024-10041 (libpam-modules 1.5.2-6+deb12u2, MEDIUM)
- CVE-2026-54411 (libpam-modules 1.5.2-6+deb12u2, MEDIUM)
- CVE-2024-10041 (libpam-runtime 1.5.2-6+deb12u2, MEDIUM)
- CVE-2026-54411 (libpam-runtime 1.5.2-6+deb12u2, MEDIUM)
- CVE-2024-10041 (libpam0g 1.5.2-6+deb12u2, MEDIUM)
- CVE-2026-54411 (libpam0g 1.5.2-6+deb12u2, MEDIUM)
- CVE-2026-86145 (libpcre2-8-0 10.42-1, HIGH)
- CVE-2026-89156 (libpcre2-8-0 10.42-1, MEDIUM)
- CVE-2026-89157 (libpcre2-8-0 10.42-1, HIGH)
- CVE-2026-89158 (libpcre2-8-0 10.42-1, MEDIUM)
- CVE-2026-89160 (libpcre2-8-0 10.42-1, MEDIUM)
- CVE-2026-89161 (libpcre2-8-0 10.42-1, HIGH)
...
- CVE-2026-53613 (libsmartcols1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-53615 (libsmartcols1 2.38.1-5+deb12u3, MEDIUM)
- CVE-2026-76642 (libsmartcols1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78408 (libsmartcols1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78409 (libsmartcols1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78410 (libsmartcols1 2.38.1-5+deb12u3, HIGH)
- CVE-2025-27587 (libssl3 3.0.20-1~deb12u2, LOW)
- CVE-2026-42767 (libssl3 3.0.20-1~deb12u2, LOW)
- CVE-2026-54874 (libssl3 3.0.20-1~deb12u2, LOW)
- CVE-2026-63072 (libssl3 3.0.20-1~deb12u2, MEDIUM)
- CVE-2026-63074 (libssl3 3.0.20-1~deb12u2, LOW)
- CVE-2026-63076 (libssl3 3.0.20-1~deb12u2, MEDIUM)
- CVE-2026-75803 (libssl3 3.0.20-1~deb12u2, MEDIUM)
- CVE-2022-27943 (libstdc++6 12.2.0-14+deb12u1, LOW)
- CVE-2013-4392 (libsystemd0 252.39-1~deb12u2, LOW)
- CVE-2023-31437 (libsystemd0 252.39-1~deb12u2, LOW)
- CVE-2023-31438 (libsystemd0 252.39-1~deb12u2, LOW)
- CVE-2023-31439 (libsystemd0 252.39-1~deb12u2, LOW)
- CVE-2026-15059 (libsystemd0 252.39-1~deb12u2, MEDIUM)
- CVE-2026-16742 (libsystemd0 252.39-1~deb12u2, HIGH)
- CVE-2026-40228 (libsystemd0 252.39-1~deb12u2, LOW)
...
- CVE-2013-4392 (libudev1 252.39-1~deb12u2, LOW)
- CVE-2023-31437 (libudev1 252.39-1~deb12u2, LOW)
- CVE-2023-31438 (libudev1 252.39-1~deb12u2, LOW)
- CVE-2023-31439 (libudev1 252.39-1~deb12u2, LOW)
- CVE-2026-15059 (libudev1 252.39-1~deb12u2, MEDIUM)
- CVE-2026-16742 (libudev1 252.39-1~deb12u2, HIGH)
- CVE-2026-40228 (libudev1 252.39-1~deb12u2, LOW)
...
- CVE-2026-53613 (libuuid1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-53615 (libuuid1 2.38.1-5+deb12u3, MEDIUM)
- CVE-2026-76642 (libuuid1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78408 (libuuid1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78409 (libuuid1 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78410 (libuuid1 2.38.1-5+deb12u3, HIGH)
- CVE-2007-5686 (login 1:4.13+dfsg1-1+deb12u2, LOW)
- CVE-2024-56433 (login 1:4.13+dfsg1-1+deb12u2, LOW)
- TEMP-0628843-DBAD28 (login 1:4.13+dfsg1-1+deb12u2, LOW)
...
- CVE-2026-53613 (mount 2.38.1-5+deb12u3, HIGH)
- CVE-2026-53615 (mount 2.38.1-5+deb12u3, MEDIUM)
- CVE-2026-76642 (mount 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78408 (mount 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78409 (mount 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78410 (mount 2.38.1-5+deb12u3, HIGH)
...
- CVE-2025-27587 (openssl 3.0.20-1~deb12u2, LOW)
- CVE-2026-42767 (openssl 3.0.20-1~deb12u2, LOW)
- CVE-2026-54874 (openssl 3.0.20-1~deb12u2, LOW)
- CVE-2026-63072 (openssl 3.0.20-1~deb12u2, MEDIUM)
- CVE-2026-63074 (openssl 3.0.20-1~deb12u2, LOW)
- CVE-2026-63076 (openssl 3.0.20-1~deb12u2, MEDIUM)
- CVE-2026-75803 (openssl 3.0.20-1~deb12u2, MEDIUM)
- CVE-2007-5686 (passwd 1:4.13+dfsg1-1+deb12u2, LOW)
- CVE-2024-56433 (passwd 1:4.13+dfsg1-1+deb12u2, LOW)
- TEMP-0628843-DBAD28 (passwd 1:4.13+dfsg1-1+deb12u2, LOW)
- CVE-2011-4116 (perl-base 5.36.0-7+deb12u3, LOW)
- CVE-2023-31486 (perl-base 5.36.0-7+deb12u3, LOW)
- CVE-2025-15649 (perl-base 5.36.0-7+deb12u3, MEDIUM)
- CVE-2026-12087 (perl-base 5.36.0-7+deb12u3, MEDIUM)
- CVE-2026-13221 (perl-base 5.36.0-7+deb12u3, CRITICAL)
- CVE-2026-15534 (perl-base 5.36.0-7+deb12u3, MEDIUM)
- CVE-2026-19487 (perl-base 5.36.0-7+deb12u3, MEDIUM)
- CVE-2026-42496 (perl-base 5.36.0-7+deb12u3, CRITICAL)
- CVE-2026-42497 (perl-base 5.36.0-7+deb12u3, HIGH)
- CVE-2026-48959 (perl-base 5.36.0-7+deb12u3, MEDIUM)
- CVE-2026-48961 (perl-base 5.36.0-7+deb12u3, MEDIUM)
- CVE-2026-48962 (perl-base 5.36.0-7+deb12u3, HIGH)
- CVE-2026-57432 (perl-base 5.36.0-7+deb12u3, HIGH)
- CVE-2026-57433 (perl-base 5.36.0-7+deb12u3, HIGH)
- CVE-2026-7010 (perl-base 5.36.0-7+deb12u3, MEDIUM)
- CVE-2026-7017 (perl-base 5.36.0-7+deb12u3, MEDIUM)
- CVE-2026-8376 (perl-base 5.36.0-7+deb12u3, CRITICAL)
- CVE-2026-9538 (perl-base 5.36.0-7+deb12u3, HIGH)
...
- CVE-2026-53613 (util-linux-extra 2.38.1-5+deb12u3, HIGH)
- CVE-2026-53615 (util-linux-extra 2.38.1-5+deb12u3, MEDIUM)
- CVE-2026-76642 (util-linux-extra 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78408 (util-linux-extra 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78409 (util-linux-extra 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78410 (util-linux-extra 2.38.1-5+deb12u3, HIGH)
...
- CVE-2026-53613 (util-linux 2.38.1-5+deb12u3, HIGH)
- CVE-2026-53615 (util-linux 2.38.1-5+deb12u3, MEDIUM)
- CVE-2026-76642 (util-linux 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78408 (util-linux 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78409 (util-linux 2.38.1-5+deb12u3, HIGH)
- CVE-2026-78410 (util-linux 2.38.1-5+deb12u3, HIGH)
- CVE-2023-45853 (zlib1g 1:1.2.13.dfsg-1, CRITICAL)
- CVE-2026-27171 (zlib1g 1:1.2.13.dfsg-1, MEDIUM)
- CVE-2026-85091 (zlib1g 1:1.2.13.dfsg-1, MEDIUM)
...
- CVE-2026-66046 (libexpat1 2.7.1-2, HIGH)
...
- CVE-2026-9672 (libgd3 2.3.3-13, HIGH)
...
- CVE-2026-18495 (libtiff6 4.7.0-3+deb13u2, MEDIUM)
...
- CVE-2026-86137 (libxml2 2.12.7+dfsg+really2.9.14-2.1+deb13u2, MEDIUM)
- CVE-2026-86138 (libxml2 2.12.7+dfsg+really2.9.14-2.1+deb13u2, HIGH)
- CVE-2026-86139 (libxml2 2.12.7+dfsg+really2.9.14-2.1+deb13u2, HIGH)
...
- CVE-2026-86142 (libxml2 2.12.7+dfsg+really2.9.14-2.1+deb13u2, HIGH)
- CVE-2026-86143 (libxml2 2.12.7+dfsg+really2.9.14-2.1+deb13u2, HIGH)
- CVE-2026-86144 (libxml2 2.12.7+dfsg+really2.9.14-2.1+deb13u2, HIGH)
...
### opensight-keycloak-sidecar.v27.5.0
...
- CVE-2026-8376 (perl-base 5.40.1-6, CRITICAL)
- CVE-2026-9538 (perl-base 5.40.1-6, HIGH)
- CVE-2026-13346 (pip 26.1.2, MEDIUM)
- TEMP-0517018-A83CE6 (sysvinit-utils 3.14-4, LOW)
- CVE-2005-2541 (tar 1.35+dfsg-3.1, LOW)
- CVE-2026-18477 (tar 1.35+dfsg-3.1, MEDIUM)
- CVE-2026-18508 (tar 1.35+dfsg-3.1, MEDIUM)
...
- CVE-2026-75595 (io.netty:netty-handler 4.1.135.Final, CRITICAL)
- CVE-2026-75596 (io.netty:netty-handler 4.1.135.Final, MEDIUM)
...
- CVE-2026-18963 (org.keycloak:keycloak-services 26.6.4, CRITICAL)
...
### opensight-notification-service-frontend.v1.14.0
...
### opensight-notification-service.v0.20.0
...
- CVE-2026-14662 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14663 (postgresql-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-14664 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14666 (postgresql-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-14668 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14669 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14670 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14671 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14672 (postgresql-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-14673 (postgresql-17 17.10-1.pgdg13+1, LOW)
- CVE-2026-14677 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14678 (postgresql-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-14679 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14680 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14681 (postgresql-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-15741 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-15742 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-16239 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-16241 (postgresql-17 17.10-1.pgdg13+1, LOW)
- CVE-2026-18024 (postgresql-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-18408 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-19385 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-6464 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-6469 (postgresql-17 17.10-1.pgdg13+1, LOW)
- CVE-2026-6470 (postgresql-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-6471 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-6473 (postgresql-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14662 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14663 (postgresql-client-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-14664 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14666 (postgresql-client-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-14668 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14669 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14670 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14671 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14672 (postgresql-client-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-14673 (postgresql-client-17 17.10-1.pgdg13+1, LOW)
- CVE-2026-14677 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14678 (postgresql-client-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-14679 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14680 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-14681 (postgresql-client-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-15741 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-15742 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-16239 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-16241 (postgresql-client-17 17.10-1.pgdg13+1, LOW)
- CVE-2026-18024 (postgresql-client-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-18408 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-19385 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-6464 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-6469 (postgresql-client-17 17.10-1.pgdg13+1, LOW)
- CVE-2026-6470 (postgresql-client-17 17.10-1.pgdg13+1, MEDIUM)
- CVE-2026-6471 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
- CVE-2026-6473 (postgresql-client-17 17.10-1.pgdg13+1, HIGH)
...
### vulnerability-intelligence-backend.v1.40.0
...
### vulnerability-intelligence-dmz-proxy.v1.40.0
...
### vulnerability-intelligence-frontend.v1.16.0
