...
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.37.1-alpha2 |
| greenbone/asset-management-frontend | 1.34.1-alpha4 |
| greenbone/opensight-postgres | 17.11.1 |
| greenbone/opensight-keycloak | 27.8.1-alpha3 |
| greenbone/opensight-opensearch | 2.22.0 |
| greenbone/opensight-ingress | 1.33.0 |
| greenbone/opensight-notification-service | 0.21.0 |
| greenbone/opensight-notification-frontend | 1.15.1-alpha4 |
| greenbone/vulnerability-intelligence-backend | 1.42.0 |
| greenbone/vulnerability-intelligence-frontend | 1.17.1-alpha3 |
| greenbone/scan-management-frontend | 0.21.1-alpha5 |
| greenbone/scan-control-backend | 0.0.2-alpha10 |
| greenbone/management-console-backend | 0.33.1-alpha3 |
| greenbone/management-console-frontend | 0.32.1-alpha4 |
...
### management-console-wst-server.v0.24.1-alpha3
