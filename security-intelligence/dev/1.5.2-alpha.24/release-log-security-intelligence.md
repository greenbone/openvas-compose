...
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.34.1-alpha3 |
...
### management-console-wst-server.v0.24.1-alpha1
...
- CVE-2026-14456 (libssl3 3.0.20-1~deb12u2, HIGH)
...
- CVE-2026-14456 (openssl 3.0.20-1~deb12u2, HIGH)
