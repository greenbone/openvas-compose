...
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.38.1-alpha6 |
| greenbone/asset-management-frontend | 1.35.1-alpha2 |
| greenbone/opensight-postgres | 17.11.1 |
| greenbone/opensight-keycloak | 27.9.2 |
...
| greenbone/opensight-notification-frontend | 1.16.1-alpha2 |
| greenbone/vulnerability-intelligence-backend | 1.42.0 |
| greenbone/vulnerability-intelligence-frontend | 1.18.1-alpha3 |
| greenbone/scan-management-frontend | 0.21.1-alpha11 |
| greenbone/scan-control-backend | 0.0.2-alpha16 |
| greenbone/management-console-backend | 0.34.0 |
| greenbone/management-console-frontend | 0.33.1-alpha3 |
