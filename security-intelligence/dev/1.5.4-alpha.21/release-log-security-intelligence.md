...
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.38.1-alpha4 |
| greenbone/asset-management-frontend | 1.35.1-alpha1 |
...
| greenbone/opensight-notification-frontend | 1.16.1-alpha1 |
| greenbone/vulnerability-intelligence-backend | 1.42.0 |
| greenbone/vulnerability-intelligence-frontend | 1.18.1-alpha1 |
| greenbone/scan-management-frontend | 0.21.1-alpha10 |
| greenbone/scan-control-backend | 0.0.2-alpha16 |
| greenbone/management-console-backend | 0.34.0 |
| greenbone/management-console-frontend | 0.33.1-alpha1 |
...
### opensight-keycloak-sidecar.v27.9.2-alpha1
