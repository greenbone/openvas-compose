...
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.37.1-alpha1 |
...
| greenbone/scan-control-backend | 0.0.2-alpha8 |
...
### vulnerability-intelligence-backend.v1.41.1-alpha2
...
- CVE-2026-66046 (libexpat 2.8.3-r0, HIGH)
- CVE-2026-76641 (libexpat 2.8.3-r0, HIGH)
