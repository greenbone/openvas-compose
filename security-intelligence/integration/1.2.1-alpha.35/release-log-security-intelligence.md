...
| Service | Version |
|-|-|
| greenbone/asset-management-backend | 1.26.0 |
| greenbone/asset-management-frontend | 1.22.0 |
| greenbone/opensight-postgres | 16.13.2 |
| greenbone/asset-management-browser | 0.0.8 |
| greenbone/opensight-keycloak | 27.0.0 |
| greenbone/opensight-opensearch | 2.21.0 |
| greenbone/opensight-ingress | 1.30.0 |
| greenbone/opensight-notification-service | 0.15.0 |
| greenbone/opensight-notification-frontend | 1.5.0 |
| vulnerability-intelligence-backend | 1.33.0 |
| vulnerability-intelligence-frontend | 1.7.0 |
| greenbone/management-console-backend | 0.17.0 |
| greenbone/user-management-frontend | 0.21.0 |
